<div class="row">
    ...
    <div class="col-lg-6 mx-auto" style="display: contents;">
        <div class="card-header" style="width: max-content;">
            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                ...
                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                    ...
                    <li class="nav-item"> <a data-toggle="pill" href="#net-banking" class="nav-link "> <i
                                class="fas fa-mobile-alt mr-2"></i> COD </a> </li>
                </ul>
            </div> <!-- End -->
                ...
                <div id="credit-card" class="tab-pane fade show active pt-3">
                    <form role="form" onsubmit="event.preventDefault()">
                        ...
                        <div class="card-footer"> 
                            <button type="button" style="height: 60px;" class="subscribe btn btn-primary btn-block shadow-sm">
                                Confirm Payment
                            </button>
                    </form>
                </div>
            ...
            <div id="paypal" class="tab-pane fade pt-3">
                ...
                <p> <button type="button" style="height: 60px;" class="btn btn-primary "><i class="fab fa-paypal mr-2"></i> Log
...
<!--                        <h6>Select your Bank</h6>
                ...
                <div class="form-group">
<!--                    <p> <button style="height: 60px; background-image: " type="button" class="btn btn-primary "><i class="fas fa-mobile-alt mr-2"></i>
                            Proceed Payment</button> </p>-->
<div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Cash on Delivery</div>
                </div>
                <p class="text-muted">Note: You selected Cash on Delivery. Please Wait for your Order, check your mail for progress on the Order and Ready the amount of money for the Order. Stay Safe </p>
            </div> <!-- End -->
            <!-- End -->
        </div>
    </div>
